...
EXTRA_SORT_FIELDS: List[dict] = [
    ...
    {"value": "average_sharpe_12_6_3_months",      "label": "Avg Sharpe Return 12 6 3 months",  "group": "Returns",
     "description": "## Avg Sharpe Return 12 6 3 months\n\n**What it means:** Average of Sharpe returns across 12, 6, and 3 month periods. Focuses on key momentum timeframes.\n\n**Why investors use it:** A balanced multi-period risk-adjusted momentum ranking."},
    ...
    {"value": "average_sharpe_6_3_months",      "label": "Avg Sharpe Return 6 3 months",  "group": "Returns",
     "description": "## Avg Sharpe Return 6 3 months\n\n**What it means:** Average of Sharpe returns across 6 and 3 month periods. Focuses on medium to short-term risk-adjusted returns.\n\n**Why investors use it:** Useful for strategies with shorter holding periods."},
    ...
    {"value": "average_return_6_3_1_months",      "label": "Avg Return 6 3 1 months",  "group": "Returns",
     "description": "## Avg Return 6 3 1 months\n\n**What it means:** Average of raw returns across 6, 3, and 1 month periods. Captures medium to short-term momentum.\n\n**Why investors use it:** Ideal for shorter-horizon momentum strategies."},
